...
class Boid {
  ...
  void go () {
    ...
    flock();
    pos.add(move);
    //String str_pos = char(pos);
    //print(pos);
    //print(pos.x);
    //print(pos.z);
    //saveStrings("./test.txt", " ")
    //print(move);
    //print(str(move.x));
    //String move_x[] = {str(move.x), str(move.y)};
    //appendTextToFile("./simulation_data.txt", str(pos.x));
    //appendTextToFile("./simulation_data.txt", str(pos.y));
    //appendTextToFile("./simulation_data.txt", str(move.x));
    //appendTextToFile("./simulation_data.txt", str(move.y));
  }
